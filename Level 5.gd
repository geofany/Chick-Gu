...
func _on_CuacaTimer_timeout():
	...
	get_node("/root/Level 5/Background").play(GlobalVar.cuaca)
	var t = rand_range(0,100)
	get_node("/root/Level 5/CuacaTimer").start(t)
...
func _on_MakananTimer_timeout():
	GlobalVar.makan = 5
	get_node("/root/Level 5/Tools/makanan/makan").play("idle")
	pass # Replace with function body.

func _on_MinumanTimer_timeout():
	GlobalVar.minum = 5
	get_node("/root/Level 5/Tools/Air/air").play("idle")
	pass # Replace with function body.

func _on_VaksinTimer_timeout():
	GlobalVar.vaks = 5
	get_node("/root/Level 5/Tools/vaksin/Vaksin").play("idle")
	pass # Replace with function body.
